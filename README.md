...
- Usage in this project:
  - `v1`: direct multi-document concatenation followed by seq2seq summarization
  - `v2`: Stage-A context/document selection, then Stage-B seq2seq summarization
...
- `notebooks/`: Jupyter notebooks for model development and experimentation
  autogenerated using [Jupytext](https://jupytext.readthedocs.io/en/latest/). 
- `sample_docs/`: AI-generated sample articles for testing
- `scripts/summarization_model_v1.py`: original notebook-style training script
